...
const makeServerPaths = function(cb) {
    global.app.path.build = global.app.path.bxbuild
    cb()
}
...
const bxbuild = gulp.series(reset, makeServerPaths, mainTasks);
const bxwatch = gulp.series(reset, makeServerPaths, mainTasks, gulp.parallel(watcher));
